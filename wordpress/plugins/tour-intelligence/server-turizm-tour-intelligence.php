 ...
 * Description: STTI v1.2.4 complete customer Tour pages with full canonical business content, full-bleed Hub/detail rendering, lossless Tour edits, persistent in-tour visual media, dynamic route endpoints and guarded publication.
 * Version: 1.2.4
 ...
 */
define('STTI_RELEASE_VERSION', '1.2.4');
...
require_once STTI_DIR . 'includes/persistence-v123.php';
require_once STTI_DIR . 'includes/customer-content-v124.php';
