 ...
 * Description: STTI v1.1.4 operator-first Tour editor and Review Queue URL-fix patch layered over the accepted v1.1 dynamic Culture Tours Hub and v1.0 controlled public Tour pilot.
 * Version: 1.1.4
 ...
 */
define('STTI_RELEASE_VERSION', '1.1.4');
