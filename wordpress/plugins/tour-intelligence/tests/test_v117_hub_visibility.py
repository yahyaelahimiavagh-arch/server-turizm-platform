...
checks = {
    "release preserves v1.1.7 lineage": release >= (1, 1, 7),
    ...
    "v117 gated render source preserved": "stti_v110_render_hub(stti_v117_hub_records())" in php,
    "v117 legacy fallback remains auditable": "add_filter('the_content', 'stti_v117_replace_hub_content', 100)" in php,
