...
checks = {
    'release/header agree': header_version == release_version,
    'release retains accepted v0.8+ renderer baseline': release_version >= (0, 8, 0),
    'compatibility runtime preserved': "define('STTI_VERSION', '0.7.1');" in plugin,
