 ...
 * Description: Shared authenticated Google Sheets direct-sync gateway for Umrah Program Intelligence and Tour Intelligence, including validated in-place refresh and controlled archive of already-live Umrah Programs.
 * Version: 0.1.4
 * Author: Server Turizm
 */
if (!defined('ABSPATH')) { exit; }
define('STDS_VERSION', '0.1.4');
...
require_once STDS_DIR . 'includes/class-stds-umrah-archive.php';
