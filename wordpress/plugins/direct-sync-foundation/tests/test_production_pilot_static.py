...
checks = {
    ...
    'selected umrah blocks protected live update': "r.operation === 'UPDATE'" in pilot and 'r.public_impact.protected' in pilot and 'Apply yapılmadı' in pilot,
    ...
    'full umrah batch blocks all writes on any preflight issue': 'HİÇBİR WRITE YAPILMADI' in client and 'if (!preflight.ok || publicBlock)' in client,
