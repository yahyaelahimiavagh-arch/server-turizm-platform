/**
 * Server Turizm ST-TDE Google Sheets Exporter v0.2.0
 *
...
function stTdeShowHelp() {
  SpreadsheetApp.getUi().alert(
    ...
    'این ماژول شیت Home را تغییر نمی‌دهد. ابتدا Hotel Directory را از WordPress کپی و اینجا وارد کنید؛ سپس Validate و Export JSON را اجرا کنید. فایل JSON فقط برای Dry Run پنل Program Intelligence است.',
